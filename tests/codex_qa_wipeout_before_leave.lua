-- Run: nvim --headless --clean -l tests/codex_qa_wipeout_before_leave.lua
...
assert(#entries == 1, "Codex session wiped during qa is persisted")
assert(entries[1].id == session_id, "Codex session id captured before wipeout")

print("codex_qa_wipeout_before_leave OK")
